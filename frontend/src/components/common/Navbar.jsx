...
const Navbar = () => {
    ...
    return (
        <nav className={`fixed z-[100] top-0 flex h-16 w-full items-center justify-center border-b-[1px] border-b-richblack-700/50 bg-richblack-900/75 backdrop-blur-lg backdrop-saturate-150 text-white transition-all duration-300 ${showNavbar}`}>
            <div className='flex w-11/12 max-w-maxContent items-center justify-between pl-2 sm:pl-4'>
                {/* Premium Logo Layout */}
                <Link to="/" className="flex items-center gap-2">
                    <img
                        src="/logo.png"
                        className="h-8 sm:h-9 w-auto object-contain hover:opacity-80 transition-opacity duration-300"
