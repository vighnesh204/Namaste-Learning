...
export default function CourseInformationForm() {
  ...
  useEffect(() => {
    // if form is in edit mode - set values after categories are loaded
    if (editCourse && courseCategories.length > 0) {
      console.log("Setting edit mode values")
      ...
      // Handle both cases: category as object or as string ID
  ...
  const isFormUpdated = () => {
    ...
    console.log("Original course values:", course)
    
    // Get category ID from course (handle both object and string cases)
